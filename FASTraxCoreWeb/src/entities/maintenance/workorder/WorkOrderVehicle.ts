...
import WorkOrderVehicleCustomerDetails from './WorkOrderVehicleCustomerDetails';
import WorkOrderVehicleMobileService from './WorkOrderVehicleMobileService';
import WorkOrderVehicleDate from './WorkOrderVehicleDate';
import WorkOrderVehicleTotal from './WorkOrderVehicleTotal';

export default interface WorkOrderVehicle extends BaseEntity {
...
export const workOrderVehicleShape = {
    ...
    vehicleId: yup.number().min(1, 'Vehicle is required.').required()
};
