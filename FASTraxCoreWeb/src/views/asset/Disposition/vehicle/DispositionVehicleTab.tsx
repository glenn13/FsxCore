...
export interface DispositionVehicleTabProps {
  isReadOnly: boolean;
}

const DispositionVehicleTab: React.FC<DispositionVehicleTabProps> = ({isReadOnly}) => {
...
export default React.memo(DispositionVehicleTab);
